...
This, when not in monotype, results in a citation when compiled by **knitr**, like this [@hopkins_transition_2008].

The reference list is then automagically created (see below).
As explained on the [Bibliographies and Citations](http://rmarkdown.rstudio.com/authoring_bibliographies_and_citations.html) page on the RStudio website, you can modify the citation style.
I've chose the University of Leeds' version of the Harvard citation style ([harvard-university-of-leeds.csl](https://github.com/citation-style-language/styles/blob/master/harvard-university-of-leeds.csl)).
